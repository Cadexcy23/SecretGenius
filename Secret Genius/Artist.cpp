...
SDL_Texture* Artist::gLvl1ClassIconBorder = NULL;
SDL_Texture* Artist::gLvl2ClassIconBorder = NULL;
SDL_Texture* Artist::gLvl3ClassIconBorder = NULL;
SDL_Texture* Artist::gLvl4ClassIconBorder = NULL;
std::vector<SDL_Texture*> Artist::gLvl4ClassIconBorderAnimation;
SDL_Texture* Artist::gPathStraight;
SDL_Texture* Artist::gPathTurn;
SDL_Texture* Artist::gPathEnd;
//letters
...
void loadCharSprites(Character::character* charToLoad, std::string texName)
{
	Artist artist;
	charToLoad->textures.up = artist.loadTexture("Resource/charSprites/" + texName + "/" + texName + "Up.png");
	charToLoad->textures.down = artist.loadTexture("Resource/charSprites/" + texName + "/" + texName + "Down.png");
	charToLoad->textures.left = artist.loadTexture("Resource/charSprites/" + texName + "/" + texName + "Left.png");
	charToLoad->textures.right = artist.loadTexture("Resource/charSprites/" + texName + "/" + texName + "Right.png");
}
...
bool Artist::loadMedia()
{
	...
	//load chars TEMP
	/*loadCharSprites(&Character::thug, "slav");
	loadCharSprites(&Character::cannonGuy, "bigGuy");
	loadCharSprites(&Character::thin, "guy");
	loadCharSprites(&Character::iceCream, "icecream");
	loadCharSprites(&Character::wizard, "flameWizard");*/
	...
	Artist::gLvl1ClassIconBorder = loadTexture("Resource/classes/lvl1IconBorder.png");
	Artist::gLvl2ClassIconBorder = loadTexture("Resource/classes/lvl2IconBorder.png");
	Artist::gLvl3ClassIconBorder = loadTexture("Resource/classes/lvl3IconBorder.png");
	Artist::gLvl4ClassIconBorder = loadTexture("Resource/classes/lvl4IconBorder.png");
	Artist::gLvl4ClassIconBorderAnimation = loadAnimationData("classes", "lvl4IconBorder", 66);
	Artist::gPathStraight = loadTexture("Resource/HUD/pathStraight.png");
	Artist::gPathTurn = loadTexture("Resource/HUD/pathTurn.png");
	Artist::gPathEnd = loadTexture("Resource/HUD/pathEnd.png");
	//letters
