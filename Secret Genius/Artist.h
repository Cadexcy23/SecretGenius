...
public:
	...
	static RGB tileSelecterRGB;

	//Put Textures here so they can be global
	static SDL_Texture* gBackground;
	static SDL_Texture* gExit;
	static SDL_Texture* gTire;
	static SDL_Texture* gLoad;
	static SDL_Texture* gNew;
	static SDL_Texture* gOptions;
	static SDL_Texture* gStart;
	static SDL_Texture* gNameBackplate;
	static SDL_Texture* gTileHoverPiece;
	static SDL_Texture* gTileInfoBackdrop;
	static SDL_Texture* gCharInfoBackdrop;
	static SDL_Texture* gCharObjectInfoBackdrop;
	static SDL_Texture* gObjectInfoBackdrop;
	static SDL_Texture* gSliderBack;
	static SDL_Texture* gSliderKnob;
	static SDL_Texture* gVolumeIcon;
	static SDL_Texture* gVolumeCrossout;
	static SDL_Texture* gShittySword;
	static SDL_Texture* gLvl1ClassIconBorder;
	static SDL_Texture* gLvl2ClassIconBorder;
	static SDL_Texture* gLvl3ClassIconBorder;
	static SDL_Texture* gLvl4ClassIconBorder;
	static std::vector<SDL_Texture*> gLvl4ClassIconBorderAnimation;
	static SDL_Texture* gPathStraight;
	static SDL_Texture* gPathTurn;
	static SDL_Texture* gPathEnd;
